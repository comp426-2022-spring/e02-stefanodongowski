...
// 1. Create other variables for assignments, exams, and engagement here
    ...
    let currentMidterms = document.querySelector('#midterms').value

    let currentCommits = document.querySelector('#commits').value

    let currentFinalProject = document.querySelector('#final').value
    if(currentSum==='')
    return;
// 2. This line is where you add the points all together. Add your other variable references here. Make sure that they match what is above and what is below in the HTML form
    let sum = parseInt(currentA00) + parseInt(currentA01) + parseInt(currentA02) +
    parseInt(currentA03) + parseInt(currentA04) + parseInt(currentA05) + 
    parseInt(currentMidterms) + parseInt(currentCommits) + parseInt(currentFinalProject) +
    parseInt(currentE01) + parseInt(currentE02);
    setCurrentSum(sum);
  }
  ...
  return (
    <div className="App">
      ...
      <form>
            ...
            <input type="text" id="midterms" placeholder="midterms" /><br/><br/>
